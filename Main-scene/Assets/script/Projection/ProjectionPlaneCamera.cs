    ...
    public class ProjectionPlaneCamera : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            if (DrawGizmos)
            {
                ...
                Gizmos.DrawLine(pos, targetObject.transform.position);
            }
        }
        ...
        private void LateUpdate()
        {
            if(ProjectionScreen != null)
            {
                Vector3 pa = ProjectionScreen.TopRight; // Bottom left
                Vector3 pb = ProjectionScreen.TopLeft; // Bottom Right
                Vector3 pc = ProjectionScreen.BottomRight; // tOp left
                Vector3 pd = ProjectionScreen.BottomLeft; // top right
                ...
                viewDir = targetObject.transform.position - transform.position;
